...
This repository holds Mosaic's architecture and direction. The implementation lives across sibling repositories: the Platform ([`platform`](https://github.com/mosaic-media/platform)), the published SDK modules build against ([`sdk`](https://github.com/mosaic-media/sdk)), the Server-Driven-UI and session contracts the Platform, modules and clients share ([`contracts`](https://github.com/mosaic-media/contracts)), the frontend workspace holding the Shell, the React SDUI runtime and the component storybook as three packages ([`web`](https://github.com/mosaic-media/web)), the signed index a Platform installs extension modules from ([`registry`](https://github.com/mosaic-media/registry)), and the modules themselves in their own repositories (the first is [`module-stremio-addons`](https://github.com/mosaic-media/module-stremio-addons)).
