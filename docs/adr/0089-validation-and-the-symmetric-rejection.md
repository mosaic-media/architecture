...
[ADR 0088](0088-fields-and-forms.md) made a screen able to carry several fields
...
unified ([ADR 0083](0083-one-generated-sdui-vocabulary.md)), and until now
...
*Rejected* — [ADR 0041](0041-cross-client-transport-two-lane-rpc.md) settled that
...
- **`$value` still works and is still owed.** Nothing in this slice changed that
  — see [ADR 0088](0088-fields-and-forms.md).
