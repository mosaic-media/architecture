...
([ADR 0004](0004-supervisor-as-host-manager.md)). A system that silently undoes
...
- **Issue types are a closed vocabulary.** The test in
  [ADR 0015](0015-open-and-closed-vocabularies.md) is "does Platform code branch
...
- **The Supervisor spools its own findings to a file and hands them over.** It
  ...
  the Platform is up ([ADR 0060](0060-the-supervisor-observes-independently.md)),
...
([ADR 0079](0079-the-platform-manages-extension-modules.md)): the code that can
