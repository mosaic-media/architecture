...
- **The module manifest's *full* shape**, and whether the declared unit is the module or the capability. A *minimal* `Manifest` is what composition and invocation run on today ([platform#15](https://github.com/mosaic-media/platform/blob/main/docs/adr/0015-module-capability-and-invocation.md), [platform#16](https://github.com/mosaic-media/platform/blob/main/docs/adr/0016-optional-module-composition.md)). M7 has since determined most of what it carries by accumulation — six records each added a declaration to it — so what is open is the shape those declarations settle into, what a Platform does with a field it does not understand, and whether the manifest names the sourced media types [platform#11](https://github.com/mosaic-media/platform/blob/main/docs/adr/0011-open-and-closed-vocabularies.md) is waiting on.
