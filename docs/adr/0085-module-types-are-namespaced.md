...
release ([ADR 0015](0015-open-and-closed-vocabularies.md),
...
over whatever a client booted with ([ADR 0040](0040-server-delivered-definitions-and-skin.md)).
...
[ADR 0083](0083-one-generated-sdui-vocabulary.md) is what makes this fixable now:
