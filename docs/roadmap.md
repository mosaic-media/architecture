...
### The active thread: a live, fully server-driven client — **Platform side in transit to the ADR 0041 transport; first-party clients not yet ported**
