...
[ADR 0121](0121-two-supervised-images-and-a-diy-path.md)'s images need actually
lives. Applies the compatibility rule
[ADR 0064](0064-extension-module-boundary.md) already uses for modules to the
other two artefacts. Uses the artefact verification of
[ADR 0065](0065-module-distribution-and-trust.md) and the keys of
[ADR 0122](0122-the-signing-key-hierarchy.md).
...
([ADR 0064](0064-extension-module-boundary.md)). The Platform and the Shell share
...
- **A Platform whose major no Shell has reached is not assemblable**, and the
  ...
  [ADR 0119](0119-operational-findings-are-durable-state.md) finding rather than
...
- **Crossing a contract major is a major upgrade** under
  [ADR 0125](0125-major-upgrades-are-never-automatic.md), whatever the version
