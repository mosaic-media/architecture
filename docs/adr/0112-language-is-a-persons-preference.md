...
[ADR 0103](0103-one-library-many-viewers.md) already established that what a
...
- **`SummaryAudioCodec` becomes wrong for someone.** It picks a track using the
  ...
  it feeds candidate ranking ([ADR 0048](0048-stream-selection-against-a-client-profile.md)).
...
- **The resolution cache is unaffected**, which is worth stating because it looks
  like it should be. [ADR 0049](0049-resolution-cache-and-capability-classes.md)
