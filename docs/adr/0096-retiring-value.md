...
[ADR 0088](0088-fields-and-forms.md) built fields and forms and left one thing
...
- **The scope wins over the action's input** for the names the form declares.
  This reverses ADR 0088, which said the opposite and gave a reason that sounded
...
ADR 0088's rule was that collected values merge *under* the action's input. The
