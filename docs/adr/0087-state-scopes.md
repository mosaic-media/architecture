...
[ADR 0086](0086-bindable-props.md) gave a prop somewhere to read *from*. It did
...
- **`State` is a primitive that draws nothing**, which is a new shape in the
  ...
  [ADR 0084](0084-vocabulary-negotiation-and-deliberate-degradation.md) handles
...
- **A binding that resolves to nothing is still silent**, exactly as
  [ADR 0086](0086-bindable-props.md) recorded. Scopes make it more likely rather
