...
[ADR 0098](0098-claiming-an-unclaimed-server.md)'s claim onto that lane.
**Date:** 2026-07-27

## Context

[ADR 0101](0101-the-pre-session-bootstrap.md) gave the doorway a vocabulary: one
...
[ADR 0036](0036-capability-gated-affordances.md) names" — and left sign-in and
claiming to M1.
...
- **The request carries the same vocabulary declaration `Bootstrap` carries**,
  ...
  ([ADR 0084](0084-vocabulary-negotiation-and-deliberate-degradation.md)), and
...
- **The unauthenticated write surface is now two calls, not one.** Both are
  ...
  the thing to keep looking at: ADR 0098 accepted the threat that whoever
