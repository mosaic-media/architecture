...
[ADR 0112](0112-language-is-a-persons-preference.md) decided *what* a viewer
...
2. **The entry point becomes a master only when there is something to declare.**
   ...
   [ADR 0109](0109-the-transcoded-stream-is-segmented.md) gave for having no
...
3. **Every track is offered; at most one is default.** ADR 0112's rule — *a
...
- **One claim here is unverified and it is a client-side one.** The origin's two
  ...
  [ADR 0111](0111-the-playlist-is-a-nominal-grid.md) allows — and the cue for
