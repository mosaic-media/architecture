...
**The unbuilt work is decomposed in [the work graph](work-graph.md)**, which
names each unit's dependencies and the check that proves it done. It carries no
status by design: this page stays the single answer to how far the build has
got.
