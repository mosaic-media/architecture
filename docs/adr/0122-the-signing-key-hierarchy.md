...
[ADR 0065](0065-module-distribution-and-trust.md) named as ongoing work and left
undefined, and is what [ADR 0063](0063-platform-binary-built-by-ci.md)'s unbuilt
signing step waits on. Does not change what is signed or how a signature is
checked — [ADR 0065](0065-module-distribution-and-trust.md) decided that and it
stands.
...
([ADR 0064](0064-extension-module-boundary.md)) to a separate process with
...
**This is the actual content of the gap ADR 0065 named**, and it is one sentence
...
ADR 0065 listed revocation as an open consequence and it remains one. What this
