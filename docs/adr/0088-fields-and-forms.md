...
[ADR 0086](0086-bindable-props.md) gave a prop somewhere to read from and
[ADR 0087](0087-state-scopes.md) gave the vocabulary somewhere to remember. What
...
- **`Form` leaves the primitive tier.** It was declared native in
  [ADR 0083](0083-one-generated-sdui-vocabulary.md) and implemented by nobody. It
