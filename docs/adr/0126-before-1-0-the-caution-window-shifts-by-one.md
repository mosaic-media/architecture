...
[ADR 0124](0124-artefacts-are-paired-by-contract-major.md) — see the decision's
second half.

## Context

ADR 0125 makes automation depend on the size of a version change: minor and
...
- **The compatibility rule is untouched, and must stay untouched.** ADR 0124
