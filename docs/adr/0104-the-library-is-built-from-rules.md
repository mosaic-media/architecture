...
[ADR 0103](0103-one-library-many-viewers.md) describes.
**Date:** 2026-07-26

## Context

[ADR 0028](0028-virtual-and-materialized-content.md) split content into a
...
([ADR 0081](0081-extension-installation-is-user-initiated-and-persistent.md)) and
...
[ADR 0028](0028-virtual-and-materialized-content.md)'s curated act — the module
...
[ADR 0028](0028-virtual-and-materialized-content.md)'s structural answer to "do
...
- Upstream load becomes predictable and continuous. That is better for a
  ...
  [ADR 0105](0105-project-credentials-in-official-builds.md) also carries.
